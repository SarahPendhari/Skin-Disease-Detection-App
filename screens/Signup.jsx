  ...
  return (
    <View style={{backgroundColor:"white",flex:1}}>
        <View style={{display:"flex",flexDirection:"row",paddingTop:50,justifyContent:"center"}}>
             <Text style={{fontSize:30,fontWeight:"bold",color:"#9966cc"}}>Signup</Text>
        </View>
        ...
        <View style={{paddingHorizontal:30,paddingVertical:20,display:"flex",gap:10}}>
           ...
           <TouchableOpacity onPress={goto}  style={{display:"flex",paddingVertical:10, borderRadius:10,paddingHorizontal:10,justifyContent:"center",alignItems:"center",marginTop:10,backgroundColor:"#9966cc"}}>
        ...
        <View style={{display:"flex",flexDirection:"row",justifyContent:"center"}}>
             ...
             <TouchableOpacity onPress={goto} >
                  <Text style={{color:"#9966cc"}}> Login</Text>
             </TouchableOpacity>
           </View>
    </View>
  )
